%Forward kinematics
function dJac = planar3R_dJac_R_analytic(t, q, dq, params)
    l1  = params.pkin(1);
    l2  = params.pkin(2);
    l3  = params.pkin(3);
    q1  = q(1);
...
%     Jac = [-l1*sin(pi/2+q1) - l2*sin(pi/2+q1+q2)-l3*sin(pi/2+q1+q2+q3),-l2*sin(pi/2+q1+q2)-l3*sin(pi/2+q1+q2+q3),-l3*sin(pi/2+q1+q2+q3);
%             l1*cos(pi/2+q1) + l2*cos(pi/2+q1+q2)+l3*cos(pi/2+q1+q2+q3), l2*cos(pi/2+q1+q2)+l3*cos(pi/2+q1+q2+q3), l3*cos(pi/2+q1+q2+q3)];
